...
const userSchema = new mongoose.Schema({
    ...
    frequency: {
        ...
        enum: {
            ...
            message: 'Frequency is either: per hour, per day, per week, per month, per task',
        },
    },
    education: {
        type: String,
    ...
    catogery: {
        ...
        enum: {
            ...
            message: 'Category must be one of: Web Design, Marketing, Business, Software Engineering, Web Developer, App Developer, Product Manager, Accountant, Ui/Ux Design, Graphics Designer',
        },
    },
    job: {
        type: String,
